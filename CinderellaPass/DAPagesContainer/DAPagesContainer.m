...
//    _pageIndicatorViewSize = CGSizeMake(108, 25);
...
//        if ([self.pageIndicatorView isKindOfClass:[DAPageIndicatorView class]]) {
//            [(DAPageIndicatorView *)self.pageIndicatorView setColor:selectedPageItemTitleColor];
//        }
...
//    return CGRectGetMaxY(self.topBar.frame) - 2. + CGRectGetHeight(self.pageIndicatorView.frame) / 2.;
    return CGRectGetHeight(self.pageIndicatorView.frame);
}
